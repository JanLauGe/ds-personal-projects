...
bbalance <- read_csv(here::here('data/bureau_balance.csv')) 
bureau <- read_csv(here::here('data/bureau.csv'))
cc_balance <- read_csv(here::here('data/credit_card_balance.csv'))
payments <- read_csv(here::here('data/installments_payments.csv')) 
pc_balance <- read_csv(here::here('data/POS_CASH_balance.csv'))
prev <- read_csv(here::here('data/previous_application.csv'))
tr <- read_csv(here::here('data/application_train.csv')) 
te <- read_csv(here::here('data/application_test.csv'))
